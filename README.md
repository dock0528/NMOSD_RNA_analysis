...
```mermaid
flowchart TD
    A(["<div style='width:300px;height:45px;text-align:center;'>10 NMOSD bulk RNA-seq<br/>(FASTQ)</div>"])
    B(["<div style='width:300px;height:45px;text-align:center;'>11 healthy control bulk RNA-seq<br/>(FASTQ)</div>"])
